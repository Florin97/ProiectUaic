...
private:
	...
	void addHandValueText(int top, int height, Hand hand, Hand *playerSecondHand, Hand *currentHand);
	int addDealerHandInfo(GameController* gameController, Hand dealerHand, int height);
public:
